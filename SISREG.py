...
for nome_arquivo in os.listdir(diretorio):
    if nome_arquivo.endswith('.csv'):
        ...
        with open(caminho_completo, 'r', encoding='utf-8', newline='') as arquivo_csv:
...
with open(arquivo_resultante, 'w', encoding='utf-8', newline='') as arquivo_resultante_csv:
    escritor_csv = csv.writer(arquivo_resultante_csv)
